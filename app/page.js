...
export default function Home() {
  return (
    ...
    <div className="flex flex-col justify-between h-screen">
      <div>
        <div className="max-w-xs:w-full bg-violet-300 relative">
          <div className="h-56">
          ...
          <div className="w-60 absolute top-0 h-full flex flex-col gap-y-6 pt-20 mx-6">
